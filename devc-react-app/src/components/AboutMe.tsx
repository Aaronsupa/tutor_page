...
function AboutMe() {
    return (
        <>
        <Box w={{ base: "70%", sm: "70%", md: "40%"}} h = {{ base: "25%", sm: "22%", md: "30%"}} display="flex" flexDirection='column'>
            <Heading as='h2' size='xl' color='#1F4172' display='flex' marginLeft='5%'>
            About Me
            </Heading>
            <Box bg='#FEFAF6' w='100%' h = '100%' p={3} color='black' borderWidth='2px' borderRadius='lg' borderColor='#D9D9D9' boxShadow='6px 6px #D9D9D9;' shadow='lg' display="flex" alignItems="center">
