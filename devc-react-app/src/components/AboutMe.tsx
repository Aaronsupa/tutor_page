...
function AboutMe() {
    return (
        ...
        <Box w={{ base: "80%", sm: "80%", md: "45%"}} h = {{ base: "25%", sm: "25%", md: "23%"}} display="flex" flexDirection='column' marginTop="2%">
            <Box bg='#FEFBF6' w='100%' h = '100%' p={3} color='black' borderWidth='2px' borderRadius='lg' borderColor='#2C4E8070' boxShadow='8px 8px #2C4E8070;' shadow='lg' display="flex" alignItems="center" flexDirection="column">
                ...
                <Box w='70%' h='90%' display= 'flex' overflowY="auto">
